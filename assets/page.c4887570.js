import{_ as u}from"./plugin-vue_export-helper.21dcd24c.js";import{d as e,B as s,E as r,M as p,N as i,K as n,C as d,D as _,y as f,f as m}from"./index.e8bf956f.js";import{_ as o}from"./index.8346ef48.js";const g=t=>(p("data-v-5df54b68"),t=t(),i(),t),q={class:"container w-full h-full max-w-full flex"},h=g(()=>n("div",{class:"demo flex-1 items-stretch relative"},[n("p",{class:"loading absolute m-0 top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-[36px] after:content-[''] after:absolute after:top-0 after:bottom-0"},"\u52A0\u8F7D\u4E2D")],-1)),x=[h],v=e({__name:"index",setup(t){return(l,c)=>(s(),r("div",q,x))}});var a=u(v,[["__scopeId","data-v-5df54b68"]]);const b=`<h1>\u6253\u70B9Loading\u6548\u679C</h1>
<h2>\u6280\u672F\u603B\u7ED3</h2>
<p>...</p>
<h2>\u4EE3\u7801\u7247\u6BB5</h2>
