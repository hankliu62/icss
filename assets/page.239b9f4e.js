import{_ as u}from"./plugin-vue_export-helper.21dcd24c.js";import{d as a,c as p,B as n,E as e,K as o,F as d,G as m,M as f,N as _,C as g,D as h,y as v,f as b}from"./index.e8bf956f.js";import{_ as l}from"./index.8346ef48.js";const x=t=>(f("data-v-0894a0b5"),t=t(),_(),t),y={class:"container w-full h-full max-w-full flex"},q={class:"demo flex-1 items-stretch flex justify-center bg-black blur-[4px] contrast-[8]"},w={class:"loading w-[30px] h-[30px] relative m-auto"},k=x(()=>o("div",{class:"base absolute top-0 left-0 right-0 bottom-0 bg-white rounded-[50%] opacity-0 translate-x-[-700%]"},null,-1)),$=a({__name:"index",setup(t){const s=p(7);return(i,I)=>(n(),e("div",y,[o("div",q,[o("div",w,[k,(n(!0),e(d,null,m(s.value,c=>(n(),e("div",{key:c,class:"ball absolute top-0 left-0 right-0 bottom-0 bg-white rounded-[50%] opacity-0 translate-x-[-700%]"}))),128))])])]))}});var r=u($,[["__scopeId","data-v-0894a0b5"]]);const B=`<h1>\u5C0F\u7403\u7A7F\u68ADLoading\u6548\u679C</h1>
<h2>\u6280\u672F\u603B\u7ED3</h2>
<p>...</p>
<h2>\u4EE3\u7801\u7247\u6BB5</h2>
